  ...
  return (
    <div className="w-full max-w-[500px] h-[100vh] border-x-2 border-gray-800 pt-[10px] relative flex flex-col justify-center">
      ...
      {!showViewers && (
        <>
          ...
          {storyData?.author?.userName == userData.userName && (
            <div
              className="absolute w-full flex items-center gap-[10px] text-white cursor-pointer h-[70px] bottom-0 p-2 left-0"
      ...
      {showViewers && (
        <>
          <div
            className="w-full h-[30%] flex items-center cursor-pointer justify-center mt-[100px] py-[30px] overflow-hidden"
